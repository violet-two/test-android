...
public class SqLiteHelperActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sq_lite_helper);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.btn_save:
                user = new User(name,Integer.parseInt(age),Long.parseLong(height),
...
//                List<User> list = mHelper.queryAll();
                List<User> list = mHelper.queryBYName(et_name.getText().toString());
                for (User u : list) {
                    Log.d("shen",u.toString());
                }
                break;
        }
    }
